 ...
 * TODO: 2. ADD SYNCHRONIZATION SO COORDINATOR CAN REQUESTS KEYS FROM STORES
 * TODO: 3. ADD DOCKER CREATION SCRIPT TO CREATE A NETWORK SETUP. WE WILL CREATE A SIMPLE WEB SERVER USING PYTHON3 THAT USES A REDIS CACHE
 * TODO: 4. FINISH?
 */
